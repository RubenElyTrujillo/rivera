...
const ASPECT_OPTIONS = [
  { value: "cuadrada", label: "Cuadrada", hint: "1:1 · Pisos y azulejos",      cls: "aspect-square"  },
  { value: "paisaje",  label: "Paisaje",  hint: "4:3 · Ambientes y espacios",  cls: "aspect-[4/3]"   },
  { value: "retrato",  label: "Retrato",  hint: "3:4 · Productos verticales",  cls: "aspect-[3/4]"   },
] as const
        ...
        return (
          ...
          >
            <div className="w-full flex justify-center">
              <div className={`w-10 ${opt.cls} rounded ${active ? "bg-[hsl(20,60%,70%)]" : "bg-[hsl(0,0%,80%)]"}`} />
            </div>
            <span className={`text-xs font-semibold ${active ? "text-[hsl(20,60%,40%)]" : "text-[hsl(0,0%,35%)]"}`}>
              {opt.label}
            </span>
